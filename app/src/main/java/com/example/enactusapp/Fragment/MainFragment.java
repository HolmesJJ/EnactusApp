 ...
 * @updateDes ${TODO}
 */
public class MainFragment extends SupportFragment implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    private void initView(View view) {
        ...
        mBottomBar.setOnTabSelectedListener(new BottomBar.OnTabSelectedListener() {
            ...
            public void onTabSelected(int position, int prePosition) {
                if(prePosition == 2 && position != 2) {
                    EventBusActivityScope.getDefault(_mActivity).post(new CameraEvent(false));
                    EventBusActivityScope.getDefault(_mActivity).post(new ObjectDetectionEvent(false));
                    ...
                    EventBusActivityScope.getDefault(_mActivity).post(new CameraEvent(true));
                }
        ...
        if (!hasPermissions(_mActivity, PERMISSIONS)) {
            MainFragment.this.requestPermissions(PERMISSIONS, PERMISSION_ALL);
        }
